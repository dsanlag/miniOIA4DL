...
/* #### Code section: decls ### */
static PyObject *__pyx_pf_9maxpool2d_maxpool_forward_cython(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_input_data, int __pyx_v_kernel_size, int __pyx_v_stride); /* proto */
...
#define __pyx_n_u_input_data __pyx_string_tab[25]
...
#define __pyx_n_u_max_h __pyx_string_tab[32]
#define __pyx_n_u_max_indices __pyx_string_tab[33]
#define __pyx_n_u_max_val __pyx_string_tab[34]
#define __pyx_n_u_max_w __pyx_string_tab[35]
#define __pyx_n_u_maxpool2d __pyx_string_tab[36]
#define __pyx_n_u_maxpool_forward_cython __pyx_string_tab[37]
...
#define __pyx_n_u_val __pyx_string_tab[51]
#define __pyx_n_u_values __pyx_string_tab[52]
#define __pyx_n_u_w __pyx_string_tab[53]
#define __pyx_n_u_w_start __pyx_string_tab[54]
#define __pyx_n_u_zeros __pyx_string_tab[55]
#define __pyx_kp_b_iso88591_6_6_6_6_b_c_Ba_b_c_Ba_6RvRs_WHT __pyx_string_tab[56]
...
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  {
    PyObject ** const __pyx_pyargnames[] = {&__pyx_mstate_global->__pyx_n_u_input_data,&__pyx_mstate_global->__pyx_n_u_kernel_size,&__pyx_mstate_global->__pyx_n_u_stride,0};
    ...
    if (__pyx_kwds_len > 0) {
      ...
      for (Py_ssize_t i = __pyx_nargs; i < 3; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("maxpool_forward_cython", 1, 3, 3, i); __PYX_ERR(0, 6, __pyx_L3_error) }
      }
    ...
    __pyx_v_kernel_size = __Pyx_PyLong_As_int(values[1]); if (unlikely((__pyx_v_kernel_size == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 7, __pyx_L3_error)
    __pyx_v_stride = __Pyx_PyLong_As_int(values[2]); if (unlikely((__pyx_v_stride == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 8, __pyx_L3_error)
  }
  goto __pyx_L6_skip;
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_input_data), __pyx_mstate_global->__pyx_ptype_5numpy_ndarray, 1, "input_data", 0))) __PYX_ERR(0, 6, __pyx_L1_error)
  __pyx_r = __pyx_pf_9maxpool2d_maxpool_forward_cython(__pyx_self, __pyx_v_input_data, __pyx_v_kernel_size, __pyx_v_stride);
...
static PyObject *__pyx_pf_9maxpool2d_maxpool_forward_cython(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_input_data, int __pyx_v_kernel_size, int __pyx_v_stride) {
  int __pyx_v_B;
  int __pyx_v_C;
  int __pyx_v_H;
  int __pyx_v_W;
  ...
  __pyx_pybuffernd_input_data.rcbuffer = &__pyx_pybuffer_input_data;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_input_data.rcbuffer->pybuffer, (PyObject*)__pyx_v_input_data, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t, PyBUF_FORMAT| PyBUF_STRIDES, 4, 0, __pyx_stack) == -1)) __PYX_ERR(0, 6, __pyx_L1_error)
  }
 ...
 *                            int kernel_size,
 *                            int stride):
 *     cdef int B = input_data.shape[0] # Nmero de imgenes en el batch             # <<<<<<<<<<<<<<
 ...
 *     cdef int out_w = (W - KW) // SW + 1  # Ancho de la salida             # <<<<<<<<<<<<<<
 * 
 *     # Reserva la matriz de salida donde ir el mximo de cada ventana.
*/
 ...
 * 
 *     # Guarda las posiciones [fila, columna] del valor mximo de cada ventana
*/
  __pyx_t_2 = NULL;
  ...
  __pyx_t_3 = __Pyx_PyLong_From_int(__pyx_v_B); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = __Pyx_PyLong_From_int(__pyx_v_C); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_6 = __Pyx_PyLong_From_int(__pyx_v_out_h); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __pyx_t_7 = __Pyx_PyLong_From_int(__pyx_v_out_w); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  __pyx_t_8 = PyTuple_New(4); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  __Pyx_GIVEREF(__pyx_t_3);
  if (__Pyx_PyTuple_SET_ITEM(__pyx_t_8, 0, __pyx_t_3) != (0)) __PYX_ERR(0, 23, __pyx_L1_error);
  __Pyx_GIVEREF(__pyx_t_5);
  if (__Pyx_PyTuple_SET_ITEM(__pyx_t_8, 1, __pyx_t_5) != (0)) __PYX_ERR(0, 23, __pyx_L1_error);
  __Pyx_GIVEREF(__pyx_t_6);
  if (__Pyx_PyTuple_SET_ITEM(__pyx_t_8, 2, __pyx_t_6) != (0)) __PYX_ERR(0, 23, __pyx_L1_error);
  __Pyx_GIVEREF(__pyx_t_7);
  if (__Pyx_PyTuple_SET_ITEM(__pyx_t_8, 3, __pyx_t_7) != (0)) __PYX_ERR(0, 23, __pyx_L1_error);
  __pyx_t_3 = 0;
  __pyx_t_5 = 0;
  __pyx_t_6 = 0;
  __pyx_t_7 = 0;
  ...
  __Pyx_GOTREF(__pyx_t_7);
  __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_7, __pyx_mstate_global->__pyx_n_u_float32); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  ...
  #endif
  {
    ...
    __Pyx_GOTREF(__pyx_t_7);
    if (__Pyx_VectorcallBuilder_AddArg(__pyx_mstate_global->__pyx_n_u_dtype, __pyx_t_6, __pyx_t_7, __pyx_callargs+2, 0) < (0)) __PYX_ERR(0, 23, __pyx_L1_error)
  ...
  /* "maxpool2d.pyx":27
 *     # Guarda las posiciones [fila, columna] del valor mximo de cada ventana
 *     # La ltima dimensin de tamao 2 almacena: [max_h, max_w]
...
*/
  ...
  __Pyx_GOTREF(__pyx_t_7);
  __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_7, __pyx_mstate_global->__pyx_n_u_zeros); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __pyx_t_7 = __Pyx_PyLong_From_int(__pyx_v_B); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  __pyx_t_8 = __Pyx_PyLong_From_int(__pyx_v_C); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  __pyx_t_2 = __Pyx_PyLong_From_int(__pyx_v_out_h); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_5 = __Pyx_PyLong_From_int(__pyx_v_out_w); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_3 = PyTuple_New(5); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_GIVEREF(__pyx_t_7);
  if (__Pyx_PyTuple_SET_ITEM(__pyx_t_3, 0, __pyx_t_7) != (0)) __PYX_ERR(0, 27, __pyx_L1_error);
  __Pyx_GIVEREF(__pyx_t_8);
  if (__Pyx_PyTuple_SET_ITEM(__pyx_t_3, 1, __pyx_t_8) != (0)) __PYX_ERR(0, 27, __pyx_L1_error);
  __Pyx_GIVEREF(__pyx_t_2);
  if (__Pyx_PyTuple_SET_ITEM(__pyx_t_3, 2, __pyx_t_2) != (0)) __PYX_ERR(0, 27, __pyx_L1_error);
  __Pyx_GIVEREF(__pyx_t_5);
  if (__Pyx_PyTuple_SET_ITEM(__pyx_t_3, 3, __pyx_t_5) != (0)) __PYX_ERR(0, 27, __pyx_L1_error);
  __Pyx_INCREF(__pyx_mstate_global->__pyx_int_2);
  __Pyx_GIVEREF(__pyx_mstate_global->__pyx_int_2);
  if (__Pyx_PyTuple_SET_ITEM(__pyx_t_3, 4, __pyx_mstate_global->__pyx_int_2) != (0)) __PYX_ERR(0, 27, __pyx_L1_error);
  __pyx_t_7 = 0;
  __pyx_t_8 = 0;
  __pyx_t_2 = 0;
  __pyx_t_5 = 0;
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_mstate_global->__pyx_n_u_int32); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  ...
  #endif
  {
    ...
    __Pyx_GOTREF(__pyx_t_5);
    if (__Pyx_VectorcallBuilder_AddArg(__pyx_mstate_global->__pyx_n_u_dtype, __pyx_t_2, __pyx_t_5, __pyx_callargs+2, 0) < (0)) __PYX_ERR(0, 27, __pyx_L1_error)
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_max_indices.rcbuffer->pybuffer, (PyObject*)((PyArrayObject *)__pyx_t_1), &__Pyx_TypeInfo_nn___pyx_t_5numpy_int32_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 5, 0, __pyx_stack) == -1)) {
  ...
  /* "maxpool2d.pyx":34
 *     cdef int max_h, max_w # Coordenadas dentro de la entrada donde se encontr el mximo
 * 
 ...
 *                     w_start = j * SW # Columna inicial de la ventana actual             # <<<<<<<<<<<<<<
 * 
 *                     max_val = input_data[b, c, h_start, w_start] # Inicializa el mximo con el primer valor de la ventana
*/
 ...
 * 
 *                     max_val = input_data[b, c, h_start, w_start] # Inicializa el mximo con el primer valor de la ventana             # <<<<<<<<<<<<<<
 *                     max_h = h_start  # Inicializa las coordenadas del mximo en esa misma posicin
 *                     max_w = w_start
*/
          ...
          __pyx_v_max_val = (*__Pyx_BufPtrStrided4d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_input_data.rcbuffer->pybuffer.buf, __pyx_t_22, __pyx_pybuffernd_input_data.diminfo[0].strides, __pyx_t_23, __pyx_pybuffernd_input_data.diminfo[1].strides, __pyx_t_24, __pyx_pybuffernd_input_data.diminfo[2].strides, __pyx_t_25, __pyx_pybuffernd_input_data.diminfo[3].strides));
 ...
 *                             val = input_data[b, c, h_start + h, w_start + w] # Lee el valor actual de la ventana             # <<<<<<<<<<<<<<
 * 
 *                             if val > max_val: # Si encuentra uno mayor, actualiza el mximo
*/
              __pyx_t_25 = __pyx_v_b;
              __pyx_t_24 = __pyx_v_c;
              __pyx_t_23 = (__pyx_v_h_start + __pyx_v_h);
              __pyx_t_22 = (__pyx_v_w_start + __pyx_v_w);
              __pyx_v_val = (*__Pyx_BufPtrStrided4d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_input_data.rcbuffer->pybuffer.buf, __pyx_t_25, __pyx_pybuffernd_input_data.diminfo[0].strides, __pyx_t_24, __pyx_pybuffernd_input_data.diminfo[1].strides, __pyx_t_23, __pyx_pybuffernd_input_data.diminfo[2].strides, __pyx_t_22, __pyx_pybuffernd_input_data.diminfo[3].strides));
 ...
 * 
*/
                __pyx_v_max_h = (__pyx_v_h_start + __pyx_v_h);
 ...
 *                                 max_w = w_start + w             # <<<<<<<<<<<<<<
 * 
 *                     output[b, c, i, j] = max_val  # Guarda el valor mximo de la ventana en la salida
*/
                __pyx_v_max_w = (__pyx_v_w_start + __pyx_v_w);
 ...
 *                     output[b, c, i, j] = max_val  # Guarda el valor mximo de la ventana en la salida             # <<<<<<<<<<<<<<
 * 
 *                     # Guarda tambin dnde estaba ese mximo en la entrada
*/
          __pyx_t_22 = __pyx_v_b;
          __pyx_t_23 = __pyx_v_c;
 ...
 *                     max_indices[b, c, i, j, 1] = max_w             # <<<<<<<<<<<<<<
 * 
 *     #Devuelve output: salida del MaxPool y max_indices: posiciones de los mximos, necesarias para backward
*/
          ...
          __pyx_t_25 = 1;
          *__Pyx_BufPtrStrided5d(__pyx_t_5numpy_int32_t *, __pyx_pybuffernd
...
const char* const bytes = "?Note that Cython is deliberately stricter than PEP-484 and rejects subclasses of builtin types. If you need to pass subclasses then set the 'annotation_typing' directive to False.add_notemaxpool2d.pyxnumpy._core.multiarray failed to importnumpy._core.umath failed to importBCHKHKW__Pyx_PyDict_NextRefSHSWWasyncio.coroutinesbccline_in_tracebackdtypefloat32__func__hh_startiinput_dataint32_is_coroutineitemsjkernel_size__main__max_hmax_indicesmax_valmax_wmaxpool2dmaxpool_forward_cython__module____name__npnumpyout_hout_woutputpop__qualname____set_name__setdefaultstride__test__valvaluesww_startzeros\200\001\360\006\000\005\022\220\032\2306\240\021\240!\330\004\021\220\032\2306\240\021\240!\330\004\021\220\032\2306\240\021\240!\330\004\021\220\032\2306\240\021\240!\340\004\022\220!\330\004\022\220!\330\004\022\220!\330\004\022\220!\340\004\026\220b\230\002\230$\230c\240\023\240B\240a\330\004\026\220b\230\002\230$\230c\240\023\240B\240a\360\006\000\0056\260R\260v\270R\270s\300#\300W\310H\320TZ\320Z\\\320\\]\360\010\000\0059\270\002\270&\300\002\300#\300S\310\007\310w\320VZ\320Z`\320`b\320bc\360\016\000\005\t\210\005\210U\220!\2201\330\010\014\210E\220\025\220a\220q\330\014\020\220\005\220U\230!\2301\330\020\024\220E\230\025\230a\230q\330\024\036\230b\240\002\240!\330\024\036\230b\240\002\240!\340\024\036\230j\250\001\250\023\250C\250y\270\001\330\024\034\230A\330\024\034\230A\340\024\030\230\005\230U\240!\2401\330\030\034\230E\240\025\240a\240q\330\034\"\240*\250A\250S\260\003\2608\2702\270S\300\010\310\002\310!\340\034\037\230t\2402\240Q\330 *\250!\330 (\250\010\260\002\260!\330 (\250\010\260\002\260!\340\024\032\230!\2303\230c\240\023\240E\250\021\360\006\000\025 \230q\240\003\2403\240c\250\023\250E\260\021\330\024\037\230q\240\003\2403\240c\250\023\250E\260\021\360\006\000\005\014\2108\2201";
    PyObject *data = NULL;
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  {
    const __Pyx_PyCode_New_function_description descr = {3, 0, 0, 27, (unsigned int)(CO_OPTIMIZED|CO_NEWLOCALS), 6};
    PyObject* const varnames[] = {__pyx_mstate->__pyx_n_u_input_data, __pyx_mstate->__pyx_n_u_kernel_size, __pyx_mstate->__pyx_n_u_stride, __pyx_mstate->__pyx_n_u_B, __pyx_mstate->__pyx_n_u_C, __pyx_mstate->__pyx_n_u_H, __pyx_mstate->__pyx_n_u_W, __pyx_mstate->__pyx_n_u_KH, __pyx_mstate->__pyx_n_u_KW, __pyx_mstate->__pyx_n_u_SH, __pyx_mstate->__pyx_n_u_SW, __pyx_mstate->__pyx_n_u_out_h, __pyx_mstate->__pyx_n_u_out_w, __pyx_mstate->__pyx_n_u_output, __pyx_mstate->__pyx_n_u_max_indices, __pyx_mstate->__pyx_n_u_b, __pyx_mstate->__pyx_n_u_c, __pyx_mstate->__pyx_n_u_i, __pyx_mstate->__pyx_n_u_j, __pyx_mstate->__pyx_n_u_h, __pyx_mstate->__pyx_n_u_w, __pyx_mstate->__pyx_n_u_h_start, __pyx_mstate->__pyx_n_u_w_start, __pyx_mstate->__pyx_n_u_max_val, __pyx_mstate->__pyx_n_u_val, __pyx_mstate->__pyx_n_u_max_h, __pyx_mstate->__pyx_n_u_max_w};
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_maxpool2d_pyx, __pyx_mstate->__pyx_n_u_maxpool_forward_cython, __pyx_mstate->__pyx_kp_b_iso88591_6_6_6_6_b_c_Ba_b_c_Ba_6RvRs_WHT, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
