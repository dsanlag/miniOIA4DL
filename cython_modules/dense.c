...
#define __PYX_HAVE__dense
#define __PYX_HAVE_API__dense
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from "dense" */
...
#define __Pyx_MODULE_NAME "dense"
extern int __pyx_module_is_main_dense;
int __pyx_module_is_main_dense = 0;

/* Implementation of "dense" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
/* #### Code section: decls ### */
static PyObject *__pyx_pf_5dense_dense_forward_cython(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_A, PyArrayObject *__pyx_v_B, PyArrayObject *__pyx_v_bias); /* proto */
...
#define __pyx_kp_u_dense_pyx __pyx_string_tab[3]
...
#define __pyx_n_u_bias __pyx_string_tab[11]
#define __pyx_n_u_cline_in_traceback __pyx_string_tab[12]
#define __pyx_n_u_dense __pyx_string_tab[13]
#define __pyx_n_u_dense_forward_cython __pyx_string_tab[14]
...
#define __pyx_kp_b_iso88591_0_T_r_U_1_E_aq_U_1_q_Cr_3a_Qc_d __pyx_string_tab[39]
...
/* Python wrapper */
static PyObject *__pyx_pw_5dense_1dense_forward_cython(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
static PyMethodDef __pyx_mdef_5dense_1dense_forward_cython = {"dense_forward_cython", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_5dense_1dense_forward_cython, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_5dense_1dense_forward_cython(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("dense_forward_cython (wrapper)", 0);
  #if !CYTHON_METH_FASTCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  ...
  {
    PyObject ** const __pyx_pyargnames[] = {&__pyx_mstate_global->__pyx_n_u_A,&__pyx_mstate_global->__pyx_n_u_B,&__pyx_mstate_global->__pyx_n_u_bias,0};
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "dense_forward_cython", 0) < (0)) __PYX_ERR(0, 6, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 3; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("dense_forward_cython", 1, 3, 3, i); __PYX_ERR(0, 6, __pyx_L3_error) }
      }
  ...
  __Pyx_RaiseArgtupleInvalid("dense_forward_cython", 1, 3, 3, __pyx_nargs); __PYX_ERR(0, 6, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __Pyx_AddTraceback("dense.dense_forward_cython", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_A), __pyx_mstate_global->__pyx_ptype_5numpy_ndarray, 1, "A", 0))) __PYX_ERR(0, 6, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_B), __pyx_mstate_global->__pyx_ptype_5numpy_ndarray, 1, "B", 0))) __PYX_ERR(0, 7, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_bias), __pyx_mstate_global->__pyx_ptype_5numpy_ndarray, 1, "bias", 0))) __PYX_ERR(0, 8, __pyx_L1_error)
  __pyx_r = __pyx_pf_5dense_dense_forward_cython(__pyx_self, __pyx_v_A, __pyx_v_B, __pyx_v_bias);
...
static PyObject *__pyx_pf_5dense_dense_forward_cython(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_A, PyArrayObject *__pyx_v_B, PyArrayObject *__pyx_v_bias) {
  int __pyx_v_m;
  int __pyx_v_p;
  int __pyx_v_n;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("dense_forward_cython", 0);
  ...
  __pyx_pybuffernd_bias.rcbuffer = &__pyx_pybuffer_bias;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_A.rcbuffer->pybuffer, (PyObject*)__pyx_v_A, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 6, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_B.rcbuffer->pybuffer, (PyObject*)__pyx_v_B, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 6, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_bias.rcbuffer->pybuffer, (PyObject*)__pyx_v_bias, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 6, __pyx_L1_error)
  }
 ...
 * 
 *     cdef int m = A.shape[0]  # Nmero de muestras (batch_size)             # <<<<<<<<<<<<<<
 *     cdef int p = A.shape[1]  # Nmero de features de entrada
 *     cdef int n = B.shape[1]  # Nmero de neuronas de salida
*/
 ...
 * 
*/
  __pyx_v_p = (__pyx_f_5numpy_7ndarray_5shape_shape(((PyArrayObject *)__pyx_v_A))[1]);
...
*/
  ...
  __pyx_t_3 = __Pyx_PyLong_From_int(__pyx_v_m); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = __Pyx_PyLong_From_int(__pyx_v_n); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 18, __pyx_L1_error)
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_mstate_global->__pyx_n_u_float32); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_C.rcbuffer->pybuffer, (PyObject*)((PyArrayObject *)__pyx_t_1), &__Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) {
...
*/
        ...
        __pyx_v_val = (__pyx_v_val + ((*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_A.rcbuffer->pybuffer.buf, __pyx_t_17, __pyx_pybuffernd_A.diminfo[0].strides, __pyx_t_18, __pyx_pybuffernd_A.diminfo[1].strides)) * (*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_B.rcbuffer->pybuffer.buf, __pyx_t_19, __pyx_pybuffernd_B.diminfo[0].strides, __pyx_t_20, __pyx_pybuffernd_B.diminfo[1].strides))));
      }
...
*/
      ...
      *__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_C.rcbuffer->pybuffer.buf, __pyx_t_19, __pyx_pybuffernd_C.diminfo[0].strides, __pyx_t_18, __pyx_pybuffernd_C.diminfo[1].strides) = (__pyx_v_val + (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_bias.rcbuffer->pybuffer.buf, __pyx_t_20, __pyx_pybuffernd_bias.diminfo[0].strides)));
    }
  }
...
__Pyx_RefNannySetupContext("PyInit_dense", 0);
  ...
  if (__pyx_module_is_main_dense) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "dense")) {
      if (unlikely((PyDict_SetItemString(modules, "dense", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
 ...
 